  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md cursor-pointer font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-foreground hover:bg-transparent hover:text-accent-foreground text-foreground",
        secondary:
      ...
      size: {
        ...
        sm: "h-9 rounded-sm gap-1.5 px-4 has-[>svg]:px-2.5 text-sm",
        lg: "h-14 rounded-sm px-7 has-[>svg]:px-4 text-lg",
        icon: "size-9",
      },
    },
    defaultVariants: {
